...
import AwardsShowcase from '@/components/main/AwardsShowcase'
...
const Page = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br p-4 md:p-8 flex flex-col items-center justify-center py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl relative z-10">
          ...
          >
            ...
            <button className="w-full flex items-center justify-center gap-2 py-2 px-4 backdrop-blur-sm bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white/90 font-medium transition-all duration-300 mt-auto">
          ...
          >
            <h2 className="text-xl font-semibold text-white mb-3">Ready to cast your vote?</h2>
            <p className="text-white/80 mb-6 flex-grow">Make your voice heard and support your favorite graduates.</p>
            <button 
              onClick={handleVoteClick}
              className="w-full flex items-center justify-center gap-2 py-2 px-4 backdrop-blur-sm bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white/90 font-medium transition-all duration-300 mt-auto">
